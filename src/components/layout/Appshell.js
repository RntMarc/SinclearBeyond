        ...
        <aside className="w-72 flex flex-col border-r border-white/5 bg-black/20 backdrop-blur-3xl z-40 relative">
              ...
              <div
                className={cn(
                  ...
                  activeEffects.showPride
                    ? "bg-rainbow shadow-[0_0_20px_rgba(255,0,0,0.4)]"
                    : "bg-primary shadow-[0_0_20px_rgba(135,255,157,0.4)]",
                )}
              >
                <span
                  className={cn(
          ...
          <nav className="flex-1 overflow-y-auto px-4 py-2 space-y-8 scrollbar-hide">
            ...
            <div>
              ...
              <div className="space-y-1">
                {navGroups.organization.map((item) => (
                  <SidebarItem
                    key={item.href}
                    {...item}
                    active={pathname.startsWith(item.href)}
            ...
            {navGroups.admin.length > 0 && (
              <div>
                <p className="px-4 text-[10px] font-black uppercase tracking-[0.2em] text-primary mb-4">
                  Admin
                </p>
                <div className="space-y-1">
          ...
          <div className="p-4 border-t border-white/5 bg-white/5 backdrop-blur-md">
            <div className="flex items-center gap-3 p-2 rounded-[2rem] bg-white/5 border border-white/5">
              ...
              <div className="flex-1 min-w-0">
                ...
                <Link
                  href="/einstellungen"
                  className="text-[10px] text-muted-foreground hover:text-primary transition-colors uppercase font-black"
                >
                  Settings
                </Link>
              </div>
