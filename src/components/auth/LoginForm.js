  ...
  const InputField = ({ label, icon: Icon, ...props }) => (
    <div className="space-y-2">
      ...
      <div className="relative group">
        ...
        <input
          {...props}
          className="w-full pl-11 pr-4 py-4 rounded-2xl bg-white/5 border border-white/5 text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-primary/50 font-bold transition-all group-hover:bg-white/10"
        />
      </div>
    </div>
  );
  ...
  if (step === "otp") {
    return (
      <main className="min-h-screen flex items-center justify-center px-6 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-electric-purple/10 blur-[120px] -z-10" />

        <div className="w-full max-w-md glass-card rounded-[3rem] p-10 md:p-16 shadow-2xl relative">
          <div className="text-center mb-12">
            <div className="w-16 h-16 bg-primary rounded-2xl flex items-center justify-center mx-auto mb-8 shadow-[0_0_30px_rgba(135,255,157,0.4)]">
          ...
          <form onSubmit={handleVerifyOtp} className="flex flex-col gap-6">
            <input
              ...
              placeholder="000000"
              required
              className="w-full px-4 py-6 rounded-3xl bg-white/5 border border-white/5 text-foreground text-center text-4xl font-display font-black tracking-[0.5em] focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all hover:bg-white/10"
            />
            {error && (
              <p className="text-destructive text-sm font-bold text-center bg-destructive/10 py-3 rounded-xl">{error}</p>
            )}
            <Button
              type="submit"
    ...
    <main className="min-h-screen flex items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md glass-card rounded-[3rem] p-10 md:p-16 shadow-2xl relative">
        ...
        >
              ...
              >
                ...
                <div className="p-6 pt-2 space-y-4">
                  <Button
                    ...
                    className="w-full py-4 bg-[#5865F2] text-white hover:bg-[#5865F2]/90 shadow-[0_0_20px_rgba(88,101,242,0.3)] border-none"
                  >
          ...
          {error && <p className="text-destructive text-sm font-bold text-center bg-destructive/10 py-3 rounded-xl">{error}</p>}
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                 <button
                  ...
                  disabled={loading}
                  className="flex items-center justify-center gap-3 p-4 rounded-3xl bg-white/5 border border-white/5 hover:bg-white/10 transition-all font-bold text-xs"
                >
                ...
                <button
                  ...
                  onClick={handleDiscordAuth}
                  disabled={loading}
                  className="flex items-center justify-center gap-3 p-4 rounded-3xl bg-[#5865F2]/10 border border-[#5865F2]/20 hover:bg-[#5865F2]/20 transition-all font-bold text-xs text-[#5865F2]"
                >
