...
import { joinForum, leaveForum, markForumAsRead, votePost, unvotePost } from "@/lib/forums/actions";
            ...
            <div className="lg:col-span-1 space-y-6">
                <div className="bg-sidebar border border-sidebar-border rounded-2xl overflow-hidden">
                    <div className="aspect-video w-full bg-muted">
                        {data.forum.image ? (
                            <img src={data.forum.image} alt={data.forum.name} className="w-full h-full object-cover" />
                        ) : (
